...
ActiveRecord::Schema.define(version: 2019_04_24_181056) do
	...
	create_table "add_users", force: :cascade do |t|
		...
		t.index ["community_id"], name: "index_add_users_on_community_id"
		t.index ["user_id"], name: "index_add_users_on_user_id"
	end

	create_table "comment_communities", force: :cascade do |t|
	...
	create_table "have_systems", force: :cascade do |t|
		t.integer "user_id"
		t.string "title"
		t.datetime "created_at", null: false
		t.datetime "updated_at", null: false
	...
	create_table "original_combat_skills", force: :cascade do |t|
	...
	create_table "users", force: :cascade do |t|
		...
		t.string "voice_chat", default: "未選択", null: false
		t.string "text_chat", default: "未選択", null: false
		t.text "profile_head_image_id"
